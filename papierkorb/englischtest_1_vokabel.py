...
class EnglischTestEineVokalel(models.Model):
    ...
    englisches_wort_1 = models.ForeignKey(v_models.EnglischesWort, related_name='englisch_test_wort_1',
                                          on_delete=models.PROTECT, verbose_name='Zu übersetzendes Wort')
    antwort_englisches_wort_1 = models.CharField(null=True, blank=True, max_length=120, verbose_name='Übersetzung')
